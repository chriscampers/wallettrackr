...
class BeaconNotificationsManager: NSObject, ESTBeaconManagerDelegate {
    ...
    func beaconManager(manager: AnyObject, didExitRegion region: CLBeaconRegion) {
        ...
        if( CLLocationManager.authorizationStatus() == CLAuthorizationStatus.AuthorizedWhenInUse ||
            ...
            _userDefault.setObject(currentLocation.coordinate.latitude, forKey: "lat")
            _userDefault.setObject(currentLocation.coordinate.longitude, forKey: "long")
            _userDefault.setObject(NSDate().description, forKey: "time")
        }
